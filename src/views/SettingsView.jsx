      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-6">
          ...
          <Card className="p-6 space-y-5">
            ...
            <div className="pt-4">
              <button 
                className="w-full flex items-center justify-center gap-2 p-3 bg-yellow-500/10 hover:bg-yellow-500/20 text-yellow-500 border border-yellow-500/20 rounded-xl font-medium transition-all group"
              >
        ...
        <div className="space-y-6">
          ...
          <Card className="p-6 space-y-5">
            ...
            <div className="pt-4 grid grid-cols-2 gap-4">
              <button 
                className="flex items-center justify-center gap-2 p-3 bg-emerald-500/10 hover:bg-emerald-500/20 text-emerald-500 border border-emerald-500/20 rounded-xl font-medium transition-all"
              >
                <RefreshCw className="w-4 h-4" />
                Testar Link
              </button>
              <button 
                className="flex items-center justify-center gap-2 p-3 bg-slate-800 hover:bg-slate-700 text-slate-200 rounded-xl font-medium transition-all"
              >
                Gerar QR Code
              </button>
            </div>
